...
//********** subscribing on out1 *******************
  ...
  //********** subscribing on out2 *******************
  if (String(topic) == "ESPxx24/relay3/out2") {
  ...
  //********** subscribing on out3 *******************
  if (String(topic) == "ESPxx24/relay3/out3") {
    Serial.print("Changing output3 on Relay to: ");
    if (messageTemp == "on") {
      Serial.println("on");
    ...
    //********** subscribing on out4 *******************
  if (String(topic) == "ESPxx24/relay3/out4") {
    Serial.print("Changing output4 on Relay to: ");
    if (messageTemp == "on") {
      Serial.println("on");
    ...
    //********** subscribing on out5 *******************
  if (String(topic) == "ESPxx24/relay3/out5") {
    Serial.print("Changing output5 on Relay to: ");
    if (messageTemp == "on") {
      Serial.println("on");
    ...
    //********** subscribing on out6 *******************
  if (String(topic) == "ESPxx24/relay3/out6") {
    Serial.print("Changing output6 on Relay to: ");
    if (messageTemp == "on") {
      Serial.println("on");
